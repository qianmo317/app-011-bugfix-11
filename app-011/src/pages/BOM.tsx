  ...
  return (
    <div className="card">
      ...
      {rooms.map((room) => {
        ...
        let buckets = 0;
        let primerBuckets = 0;
        const paintRate = paintMat.coverage || 12;
        const primerRate = primerMat ? paintRate : 0;
        let leftArea = netArea / 1000000;
        while (leftArea > 0) {
          if (leftArea >= paintRate) {
            leftArea = leftArea - paintRate;
          } else {
            leftArea = 0;
          }
          buckets += 1;
          if (primerRate > 0 && leftArea >= 0) {
            primerBuckets += 1;
          }
        }
